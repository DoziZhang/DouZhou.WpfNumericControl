...
{
    /// <summary>
    /// short类型的数字控件(-32768~32767)
    /// </summary>
    /// <remarks>
    /// 已知问题：当StringFormat属性为X或x时，只能输入一位数值，无法输入多位数值；只能通过增加按钮或减少按钮/上下键/粘贴来改变值
    /// </remarks>
    public class NumericUpDownInt16 : NumericUpDownBase, INumericUpDown<short>
    {
        static NumericUpDownInt16()
        {
            //重写默认样式
            DefaultStyleKeyProperty.OverrideMetadata(typeof(NumericUpDownInt16), new FrameworkPropertyMetadata(typeof(NumericUpDownInt16)));
        }
        #region 基类功能实现
        ...
        private void TryParseTextToValue()
        {
            ...
            //尝试转换成decimal类型
            if (short.TryParse(sValueString, style, culture, out short value))
            {
                //转换成功后，强制转换成short类型
                if (value < Minimum)
                {
        ...
        /// </summary>
        /// <remarks>
        /// short类型支持的格式化字符串有：G、N0、X、x,D（通用、无小数数字、十六进制、十六进制小写、十进制数）
        /// </remarks>
        ...
        public static readonly DependencyProperty StringFormatProperty =
            DependencyProperty.Register("StringFormat", typeof(string), typeof(NumericUpDownInt16), new PropertyMetadata("G", OnStringFormatChanged, OnStringFormatCoerceValue));
        ...
        private static void OnStringFormatChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (d is NumericUpDownInt16 numeric)
            {
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(short), typeof(NumericUpDownInt16), new PropertyMetadata((short)0, OnValueChanged, OnCoerceValue));
        ...
        private static void OnValueChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                //获取旧值
                short oldValue = (short)e.OldValue;
                //获取新值
        ...
        private static string UpdateValueString(string stringFormat, short newValue)
        {
            try
            {
                //十六进制、数字、通用格式
        ...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(short), typeof(NumericUpDownInt16), new PropertyMetadata(short.MinValue, OnMinimumChanged, OnMinimumCoerceValue));
        ...
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(short), typeof(NumericUpDownInt16), new PropertyMetadata(short.MaxValue, OnMaximumChanged, OnMaximumCoerceValue));
        ...
        {
            get { return (short)GetValue(IncrementProperty); }
            set { SetValue(IncrementProperty, value); }
        }
        public static readonly DependencyProperty IncrementProperty =
            DependencyProperty.Register("Increment", typeof(short), typeof(NumericUpDownInt16), new PropertyMetadata((short)1, OnIncrementChanged, OnIncrementCoerceValue));
        ...
        public static readonly RoutedEvent ValueChangedEvent = EventManager.RegisterRoutedEvent("ValueChanged",
                                                                                                ...
                                                                                                typeof(NumericUpDownInt16));
        /// <summary>
        /// 值改变事件
        /// </summary>
        public event RoutedPropertyChangedEventHandler<short> ValueChanged
        {
        ...
        protected virtual void OnValueChanged(short oldValue, short newValue)
        {
            RoutedPropertyChangedEventArgs<short> arg = new RoutedPropertyChangedEventArgs<short>(oldValue, newValue, ValueChangedEvent);
            RaiseEvent(arg);
        }
        #endregion

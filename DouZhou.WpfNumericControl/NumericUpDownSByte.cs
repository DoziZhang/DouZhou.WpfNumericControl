...
{
    /// <summary>
    /// sbyte类型的数字控件(-127~127)
    /// </summary>
    /// <remarks>
    /// 已知问题：当StringFormat属性为X或x时，只能输入一位数值，无法输入多位数值；只能通过增加按钮或减少按钮/上下键/粘贴来改变值
    /// </remarks>
    public class NumericUpDownSByte : NumericUpDownBase, INumericUpDown<sbyte>
    {
        static NumericUpDownSByte()
        {
            //重写默认样式
            DefaultStyleKeyProperty.OverrideMetadata(typeof(NumericUpDownSByte), new FrameworkPropertyMetadata(typeof(NumericUpDownSByte)));
        }
        #region 基类功能实现
        ...
        private void TryParseTextToValue()
        {
            ...
            //这里不能直接用int.TryParse,Sbyte的值范围为-128~127，sbyte的负数使用int.TryParse会转换错误
            if (sbyte.TryParse(sValueString, style, culture, out sbyte value))
            {
                //转换成功后，强制转换成sbyte类型
                if (value < Minimum)
                {
        ...
        /// </summary>
        /// <remarks>
        /// sbyte类型支持的格式化字符串有：G、N0、X、x,D（通用、无小数数字、十六进制、十六进制小写、十进制数）
        /// </remarks>
        ...
        public static readonly DependencyProperty StringFormatProperty =
            DependencyProperty.Register("StringFormat", typeof(string), typeof(NumericUpDownSByte), new PropertyMetadata("G", OnStringFormatChanged, OnStringFormatCoerceValue));
        ...
        private static void OnStringFormatChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (d is NumericUpDownSByte numeric)
            {
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(sbyte), typeof(NumericUpDownSByte), new PropertyMetadata((sbyte)0, OnValueChanged, OnCoerceValue));
        ...
        private static void OnValueChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                //获取旧值
                sbyte oldValue = (sbyte)e.OldValue;
                //获取新值
                sbyte newValue = (sbyte)e.NewValue;
                IsValueChanged = true;
        ...
        private static string UpdateValueString(string stringFormat, sbyte newValue)
        {
            try
            {
                //十六进制、数字、通用格式
        ...
        {
            get { return (sbyte)GetValue(MinimumProperty); }
            set { SetValue(MinimumProperty, value); }
        }

        // Using a DependencyProperty as the backing store for Minimum.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(sbyte), typeof(NumericUpDownSByte), new PropertyMetadata(sbyte.MinValue, OnMinimumChanged, OnMinimumCoerceValue));
        ...
        {
            get { return (sbyte)GetValue(MaximumProperty); }
            set { SetValue(MaximumProperty, value); }
        }
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(sbyte), typeof(NumericUpDownSByte), new PropertyMetadata(sbyte.MaxValue, OnMaximumChanged, OnMaximumCoerceValue));
        ...
        {
            get { return (sbyte)GetValue(IncrementProperty); }
            set { SetValue(IncrementProperty, value); }
        }
        public static readonly DependencyProperty IncrementProperty =
            DependencyProperty.Register("Increment", typeof(sbyte), typeof(NumericUpDownSByte), new PropertyMetadata((sbyte)1, OnIncrementChanged, OnIncrementCoerceValue));
        ...
        public static readonly RoutedEvent ValueChangedEvent = EventManager.RegisterRoutedEvent("ValueChanged",
                                                                                                ...
                                                                                                typeof(RoutedPropertyChangedEventHandler<sbyte>),
                                                                                                typeof(NumericUpDownSByte));
        /// <summary>
        /// 值改变事件
        /// </summary>
        public event RoutedPropertyChangedEventHandler<sbyte> ValueChanged
        {
        ...
        protected virtual void OnValueChanged(sbyte oldValue, sbyte newValue)
        {
            RoutedPropertyChangedEventArgs<sbyte> arg = new RoutedPropertyChangedEventArgs<sbyte>(oldValue, newValue, ValueChangedEvent);
            RaiseEvent(arg);
        }
        #endregion

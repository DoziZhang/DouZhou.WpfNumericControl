...
{
    /// <summary>
    /// ushort类型的数字控件(0~65535)
    /// </summary>
    /// <remarks>
    /// 已知问题：当StringFormat属性为X或x时，只能输入一位数值，无法输入多位数值;只能通过增加按钮或减少按钮/上下键/粘贴来改变值
    /// </remarks>
    public class NumericUpDownUInt16 : NumericUpDownBase, INumericUpDown<ushort>
    {
        static NumericUpDownUInt16()
        {
            //重写默认样式
            DefaultStyleKeyProperty.OverrideMetadata(typeof(NumericUpDownUInt16), new FrameworkPropertyMetadata(typeof(NumericUpDownUInt16)));
        }
        #region 基类功能实现
        ...
        /// </summary>
        /// <remarks>
        /// ushort类型支持的格式化字符串有：G、N0、X、x,D（通用、无小数数字、十六进制、十六进制小写、十进制数）
        /// </remarks>
        ...
        public static readonly DependencyProperty StringFormatProperty =
            DependencyProperty.Register("StringFormat", typeof(string), typeof(NumericUpDownUInt16), new PropertyMetadata("G", OnStringFormatChanged, OnStringFormatCoerceValue));
        ...
        public ushort Value
        {
            get { return (ushort)GetValue(ValueProperty); }
            set { SetValue(ValueProperty, value); }
        }

        // Using a DependencyProperty as the backing store for Value.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(ushort), typeof(NumericUpDownUInt16), new PropertyMetadata((ushort)0, OnValueChanged, OnCoerceValue));
        ...
        private static void OnValueChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                //获取旧值
                ushort oldValue = (ushort)e.OldValue;
                //获取新值
                ushort newValue = (ushort)e.NewValue;
                IsValueChanged = true;
        ...
        private static string UpdateValueString(string stringFormat, ushort newValue)
        {
            try
            {
                //十六进制、数字、通用格式
                if (string.Equals(stringFormat, "X", StringComparison.OrdinalIgnoreCase))
                {
                    string sFormat = "0x{0:" + stringFormat + "4}";
        ...
        {
            get { return (ushort)GetValue(MinimumProperty); }
            set { SetValue(MinimumProperty, value); }
        }

        // Using a DependencyProperty as the backing store for Minimum.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(ushort), typeof(NumericUpDownUInt16), new PropertyMetadata(ushort.MinValue, OnMinimumChanged, OnMinimumCoerceValue));
        ...
        {
            get { return (ushort)GetValue(MaximumProperty); }
            set { SetValue(MaximumProperty, value); }
        }
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(ushort), typeof(NumericUpDownUInt16), new PropertyMetadata(ushort.MaxValue, OnMaximumChanged, OnMaximumCoerceValue));
        ...
        {
            get { return (ushort)GetValue(IncrementProperty); }
            set { SetValue(IncrementProperty, value); }
        }
        public static readonly DependencyProperty IncrementProperty =
            DependencyProperty.Register("Increment", typeof(ushort), typeof(NumericUpDownUInt16), new PropertyMetadata((ushort)1, OnIncrementChanged, OnIncrementCoerceValue));
        ...
        public static readonly RoutedEvent ValueChangedEvent = EventManager.RegisterRoutedEvent("ValueChanged",
                                                                                                ...
                                                                                                typeof(RoutedPropertyChangedEventHandler<ushort>),
                                                                                                typeof(NumericUpDownUInt16));
        /// <summary>
        /// 值改变事件
        /// </summary>
        public event RoutedPropertyChangedEventHandler<ushort> ValueChanged
        {
        ...
        protected virtual void OnValueChanged(ushort oldValue, ushort newValue)
        {
            RoutedPropertyChangedEventArgs<ushort> arg = new RoutedPropertyChangedEventArgs<ushort>(oldValue, newValue, ValueChangedEvent);
            RaiseEvent(arg);
        }
        #endregion

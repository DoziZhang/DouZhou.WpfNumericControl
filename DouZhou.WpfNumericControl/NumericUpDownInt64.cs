...
namespace DouZhou.WpfNumericControl
{
    ...
    /// </remarks>
    public class NumericUpDownInt64 : NumericUpDownBase, INumericUpDown<long>
    {
        static NumericUpDownInt64()
        {
            //重写默认样式
            DefaultStyleKeyProperty.OverrideMetadata(typeof(NumericUpDownInt64), new FrameworkPropertyMetadata(typeof(NumericUpDownInt64)));
        }
        #region 基类功能实现
        ...
        private void TryParseTextToValue()
        {
            ...
            //尝试转换成decimal类型
            if (long.TryParse(sValueString, style, culture, out long value))
            {
                //转换成功后，强制转换成long类型
                if (value < Minimum)
                {
        ...
        /// </summary>
        /// <remarks>
        /// long类型支持的格式化字符串有：G、N0、X、x,D（通用、无小数数字、十六进制、十六进制小写、十进制数）
        /// </remarks>
        ...
        public static readonly DependencyProperty StringFormatProperty =
            DependencyProperty.Register("StringFormat", typeof(string), typeof(NumericUpDownInt64), new PropertyMetadata("G", OnStringFormatChanged, OnStringFormatCoerceValue));
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(long), typeof(NumericUpDownInt64), new PropertyMetadata((long)0, OnValueChanged, OnCoerceValue));
        ...
        private static string UpdateValueString(string stringFormat, long newValue)
        {
            try
            {
                //十六进制、数字、通用格式
        ...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(long), typeof(NumericUpDownInt64), new PropertyMetadata(long.MinValue, OnMinimumChanged, OnMinimumCoerceValue));
        ...
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(long), typeof(NumericUpDownInt64), new PropertyMetadata(long.MaxValue, OnMaximumChanged, OnMaximumCoerceValue));
        ...
        {
            get { return (long)GetValue(IncrementProperty); }
            set { SetValue(IncrementProperty, value); }
        }
        public static readonly DependencyProperty IncrementProperty =
            DependencyProperty.Register("Increment", typeof(long), typeof(NumericUpDownInt64), new PropertyMetadata((long)1, OnIncrementChanged, OnIncrementCoerceValue));
        ...
        protected virtual void OnValueChanged(long oldValue, long newValue)
        {
            RoutedPropertyChangedEventArgs<long> arg = new RoutedPropertyChangedEventArgs<long>(oldValue, newValue, ValueChangedEvent);
            RaiseEvent(arg);
        }
        #endregion
